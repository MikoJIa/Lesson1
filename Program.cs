...
// Функция, на вход получает параметр, на выходе выводит с консоли значение
...
System.Console.WriteLine("Квадрат числа " + value + " равен " + result);        // Вывод результата с помощью конкатенации
